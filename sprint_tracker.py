...
# Convertir las columnas 'Sprint' a tipo str para evitar conflictos al hacer merge
resumen_agg = solicitudes.copy()
resumen_agg["Sprint"] = resumen_agg["Sprint"].astype(str)
sprints["Sprint"] = sprints["Sprint"].astype(str)
